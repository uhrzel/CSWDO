                    ...
                    <div class="modal-content">
                        ...
                        <form action="{{ route('social-worker.index', ['clientId' => $client->id]) }}" method="POST">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody id="familyMembersTableBody">
                                            @forelse($client->familyMembers as $familyMember)
                                            <tr>
                                                <!-- Family Member Data -->
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary" id="nextBtnFam{{ $client->id }}">
                                    <i class="fas fa-arrow-right"></i>
                                </button>
                            </div>
                        </form>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('saveBtn').addEventListener('click', function() {
            ...
            // Function to get element value or default to empty string
            ...
            formData.append('middle', getValue('middle'));
            formData.append('suffix', getValue('suffix'));
            formData.append('address', getValue('address'));
            formData.append('date_of_birth', getValue('date_of_birth'));
            formData.append('pob', getValue('pob'));
            formData.append('sex', getValue('sex'));

            formData.append('educational_attainment', getValue('educational_attainment'));
            formData.append('civil_status', getValue('civil_status'));
            formData.append('religion', getValue('religion'));
            formData.append('other_religion', getValue('other_religion'));

            formData.append('nationality', getValue('nationality'));
            formData.append('other_nationality', getValue('other_nationality'));
            formData.append('occupation', getValue('occupation'));

            formData.append('monthly_income', getValue('monthly_income'));
            formData.append('contact_number', getValue('contact_number'));
            formData.append('source_of_referral', getValue('source_of_referral'));
            formData.append('house_structure', getValue('house_structure'));
            formData.append('floor', getValue('floor'));
            formData.append('type', getValue('type'));
            formData.append('number_of_rooms', getValue('number_of_rooms'));

            formData.append('monthly_expenses', getValue('monthly_expenses'));
            formData.append('indicate', getValue('indicate'));
            formData.append('tracking', getValue('tracking'));
            formData.append('other_appliances', getValue('other_appliances'));
            formData.append('appliances', getValue('appliances'));
            formData.append('circumstances_of_referral', getValue('circumstances_of_referral'));
            formData.append('family_background', getValue('family_background'));

            formData.append('health_history', getValue('health_history'));
            formData.append('economic_situation', getValue('economic_situation'));
            formData.append('problem_presented', getValue('problem_presented'));
            formData.append('problem_identification', getValue('problem_identification'));
            formData.append('service', getValue('service'));
            formData.append('clientServices', getValue('clientServices'));
            formData.append('home_visit', getValue('home_visit'));

            formData.append('interviewee', getValue('interviewee'));
            formData.append('interviewed_by', getValue('interviewed_by'));
            formData.append('layunin', getValue('layunin'));
            formData.append('resulta', getValue('resulta'));
            formData.append('initial_agreement', getValue('initial_agreement'));
            formData.append('data_gather', getValue('data_gather'));
            formData.append('assessment', getValue('assessment'));

            formData.append('case_management_evaluation', getValue('case_management_evaluation'));
            formData.append('approving', getValue('approving'));
            formData.append('eval', getValue('eval'));
            ...
            fetch('{{ route("social-worker.update", ["id" => $client->id]) }}', {
                    method: 'POST',
                    body: formData,
                    headers: {
    ...
    function successEdit(formIdEdit, event) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                document.getElementById(formIdEdit).submit(); // Submit the form if user confirms
            }
        });
    }
    ...
    function confirmDeleteFam(familyMemberId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                document.getElementById('famform-' + familyMemberId).submit();
            }
        });
    }
    ...
    /* 
        ...
        $(document).ready(function() {
            $('[id^=nextBtnFam]').on('click', function() {
                let clientId = $(this).attr('id').replace('nextBtnFam', '');
                let currentModalId = $(this).closest('.modal').attr('id');
        ...
        $(document).ready(function() {
            $('[id^=nextBtn2]').on('click', function() {
                ...
                let currentModalId = $(this).closest('.modal').attr('id');
                let nextModalId = 'nextModal3' + clientId;
        ...
        $(document).ready(function() {
            $('[id^=prevBtnFam]').on('click', function() {
                let clientId = $(this).attr('id').replace('prevBtnFam', '');
                let currentModalId = $(this).closest('.modal').attr('id');
    ...
    $(document).ready(function() {
        ...
        handleNavigation('nextBtn1', 'nextModal', true);
        handleNavigation('nextBtnFam', 'nextModal2', true);
        handleNavigation('nextBtn3', 'nextModal3', true);
        handleNavigation('nextBtn4', 'nextModal4', true);
        handleNavigation('nextBtn5', 'nextModal5', true);
        handleNavigation('nextBtn6', 'nextModal6', true);
        handleNavigation('nextBtn7', 'nextModal7', true);



        // Navigation for previous modals
        handleNavigation('prevBtnFam', 'openEditModal', true);
        handleNavigation('prevBtn1', 'nextModal', true);
        handleNavigation('prevBtn2', 'nextModal2', true);
        handleNavigation('prevBtn3', 'nextModal3', true);
        handleNavigation('prevBtn4', 'nextModal4', true);
        handleNavigation('prevBtn5', 'nextModal5', true);
